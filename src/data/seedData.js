...
export const INITIAL_CONFIG = {
    ...
    nomeEstabelecimento: 'FideliBurguer Artisan & Shakes'
};
...
export const INITIAL_SMS_LOGS = [
    {
        ...
        clienteNome: 'Mariana Costa',
        mensagem: 'FideliBurguer: Você ganhou 125 pontos na comanda CMD-4892! Seu novo saldo é 240 pts. Obrigado pela visita! 🍔',
        tipo: 'pontos_ganhos',
        dataHora: todayISO,
        lida: true
    },
    {
        ...
        clienteNome: 'Rafael Santos',
        mensagem: 'FideliBurguer: Sua compra da comanda CMD-4898 (580 pts) está aguardando liberação do gerente. Você receberá uma mensagem assim que aprovado!',
